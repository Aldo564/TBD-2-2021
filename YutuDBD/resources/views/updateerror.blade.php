			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-content">
						...
						<form action="/volver" method="GET" class="login-form">
							<h2> Error al actualizar los datos. </h2>
							@if($ver == 0)
								<h6> La contraseña ingresada es incorrecta. </h6>
							@else
								@if($nombre != NULL)
									<h6> Nombre de usuario ya existe. </h6>
								@endif
								@if($email != NULL)
									<h6> El correo ingresado ya posee una cuenta. </h6>
								@endif
							@endif

	            <div class="text-center">
	                <button class="btn btn-sm" type="submit">Regresar</button>
	            </div>
	      		</form>
				</div><!-- .col -->
			...
			<div class="col-lg-4">
					...
					<div class="sidebar-section">
						<div class="sidebar-widget category">
							...
							<ul>
								<li><a href="upload">Upload a video</a></li>
