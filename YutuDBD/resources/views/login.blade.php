            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8 col-sm-8 text-center">
                    <div class="user-page-box">
                        ...
                        <span class="small-heading">Don’t adventures ever have an end? I suppose not. Someone else always has to carry on the story</span>
                        <form method="POST" action="{{ route('verificatorLogin') }}" class="login-form">
                            <div class="input-item">
                                <input type="text" placeholder="Your Nickname" class="input-line-simple" style="color:aliceblue" name="nickname" id="nickname">
                            </div>
                            <div class="input-item">
                                <input type="password" placeholder="Password" class="input-line-simple" style="color:aliceblue" name="contrasenia" id="contrasenia">
                            </div>
                            <div class="gaps"></div>
                            <div class="text-center">
                                <button class="btn btn-alt" type="submit">Log in</button>
                            </div>
                        </form>
                    </div>
                    <div class="gaps size-2x"></div>
                    <div class="form-note">
                        Not a member? <a href="{{url('/s')}}">Sign up now</a>
                    </div>
                </div>
            </div>
        </div>
