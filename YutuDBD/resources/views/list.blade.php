...
<body class="theme-dark" data-spy="scroll" data-target="#mainnav" data-offset="80">
		...
		<div id="header" class="page-banner d-flex align-items-center">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="page-head">
							<h2 class="page-heading">{{ $list->Nombre }}</h2>
    ...
    <div class="container">
        <div class = "container pt-4">
            <div class= "row">
				@if(!empty($sinopsis))
					@foreach($sinopsis as $sp)
						<div class="col-4" style="padding-top: 15px">
							<div class = "card">
								<a href = "{{url('showMovie/'.$sp->id)}}"><img
									src="{{$sp->link_imagen}}"
									class="card-img-top"
									width="100" height="200"
								/></a>
								<div class="card-body">
									<a href = "{{url('showMovie/'.$sp->id)}}" ><h5 class="card-title" style="color:#000000" >{{$sp->titulo_video}}</h5>
									<p class="card-text" style="color:#000000" >{{$sp->descripcion}}</p></a>
									<a href = "{{url('showMovie/'.$sp->id)}}" class="btn btn-primary">Watch</a>
								</div>
							</div>
						</div>
					@endforeach
				...
				<div class="col-lg-6 offset-lg-0 col-sm-8 offset-sm-2 "><!-- .col -->
                    <div class="blog-item animated" data-animate="fadeInUp" data-delay="0">
                        <h5 class="blog-title" ><a href="#">Any movies added yet :(</a></h5> <!-- titulo-->
                    </div>
                </div><!-- .col -->
                @endif
            </div>
