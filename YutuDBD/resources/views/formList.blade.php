            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8 col-sm-8 text-center">
                    <div class="user-page-box">
                        ...
                        <h5>Create a List</h5>
                        <span class="small-heading">Even the smallest person can change the course of the future..</span>


                        <form method= "POST" action="{{url('/creteList')}}">
                            <div class="input-item">
                                <input style="color:#6c757d" type="text" placeholder="The name of the list" class="input-line-simple" name="nombre" id="nombre" value=""  required>
                            </div>
                            <div class="input-item">
                                <input style="color:#6c757d" type="text" placeholder="Description of you list" class="input-line-simple" name="descripcion" id="descripcion" value="" required>
                            </div>
                            <button class="btn btn-sm" type= "submit">Create List</button>
                        </form>
                    </div>
