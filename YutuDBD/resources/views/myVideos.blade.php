            ...
            <div class= "row">
                    ...
                    @foreach($sinopsis as $sp)
                        @foreach($admin as $adm)
                            @if($adm['id_usuario'] == session('user')->id and $sp['id']==$adm['id_sinopsis'])
                                <div class="col-4" style="padding-top: 15px">
                                    <div class = "card">
                                        ...
                                        />
                                        <div class="card-body">
                                            <h5 class="card-title" style="color:#000000">{{$sp->titulo_video}}</h5>
                                            <p class="card-text" style="color:#000000" >{{$sp->descripcion}}</p>
                                            <a href = "{{url('/synopsis/'.$sp->id)}}" class="btn btn-primary">Editar video</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
