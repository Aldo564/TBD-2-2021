			...
			<div class="row text-center">
				<div class="col">
					<div class="section-head">
						<h2 class="section-title animated" data-animate="fadeInUp" data-delay="0">My black List<span>Lists</span></h2>
					</div>
				</div>
			</div><!-- .row -->
                <a href="{{url('/formList')}}">Create a List<br><br></a>
                        ...
                        <div class="col-lg-4 offset-lg-0 col-sm-8 offset-sm-2 "><!-- .col -->
                            <div class="blog-item animated" data-animate="fadeInUp" data-delay="0">
                                <div class="blog-texts">
                                    <h5 class="blog-title" ><a href="{{ url('list/'.$li->id) }}">{{ $li->Nombre }}</a></h5> <!-- titulo-->
                                </div>
                            </div>
                        </div><!-- .col -->
                    @endforeach
                ...
                <div class="col-lg-6 offset-lg-0 col-sm-8 offset-sm-2 "><!-- .col -->
                    <div class="blog-item animated" data-animate="fadeInUp" data-delay="0">
                        <h5 class="blog-title" ><a href="#">Any lists found yet :(</a></h5> <!-- titulo-->
                    </div>
                </div><!-- .col -->
                @endif
				</div><!-- .row -->
